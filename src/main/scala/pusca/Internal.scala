...
object Internal {
  ...
  def markSideEffect[A](a: A): A @returnedSideEffect = throw new UnsupportedOperationException
  def markSideEffectFree[A](a: A): A @returnedSideEffectFree = throw new UnsupportedOperationException
